...
//     useEffect(() => {
//         // Split the colors parameter by comma to get individual color values
//         const colorValues = colors.split(',');

//         // Set the color values to both baseColorArray and colorArray state variables
//         setBaseColorArray(colorValues);
...
//                     <button type="button" className="btn btn-success" onClick={resetColor}>Reset</button>
//                 </div>
//             </div>
//             <div className="color-container">
//                 <div className="mini-page" id="color-page">
